...
export default {
  ...
  computed: {
    ...
    link () {
      ...
      return `https://github.com/${this.settings.github}/edit/${this.settings.defaultBranch}/${this.settings.directory || 'docs/'}content${this.document.path}${this.document.extension}`
    }
  }
}
</script>
